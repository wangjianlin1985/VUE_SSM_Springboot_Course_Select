				...
				<div class="tab-content">
				    ...
				    <div role="tabpanel" class="tab-pane active" id="scoreInfoAdd"> 
						  ...
						  <div class="form-group">
						  	 <label for="scoreInfo_studentNumber_user_name" class="col-md-2 text-right">学生:</label>
						  	 <div class="col-md-8">
							    <select id="scoreInfo_studentNumber_user_name" name="scoreInfo.studentNumber.user_name" class="form-control">
							    </select>
						  	 </div>
						  </div>
						  <div class="form-group">
						  	 <label for="scoreInfo_courseNumber_courseNumber" class="col-md-2 text-right">课程:</label>
						  	 <div class="col-md-8">
