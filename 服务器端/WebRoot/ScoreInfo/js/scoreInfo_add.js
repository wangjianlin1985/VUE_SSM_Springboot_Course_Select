$(function () {
	$("#scoreInfo_studentNumber_user_name").combobox({
	    url:'Student/listAll',
        ...
        onLoadSuccess: function () { //数据加载完毕事件
            var data = $("#scoreInfo_studentNumber_user_name").combobox("getData"); 
            if (data.length > 0) {
                $("#scoreInfo_studentNumber_user_name").combobox("select", data[0].user_name);
            }
        }
	});
