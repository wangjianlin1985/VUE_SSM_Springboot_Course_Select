				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>记录编号</td><td>学生</td><td>课程</td><td>成绩得分</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="scoreInfoQueryForm" id="scoreInfoQueryForm" action="<%=basePath %>ScoreInfo/frontlist" class="mar_t15" method="post">
            <div class="form-group">
            	<label for="studentNumber_user_name">学生：</label>
                <select id="studentNumber_user_name" name="studentNumber.user_name" class="form-control">
                	<option value="">不限制</option>
	 				<%
	 				for(Student studentTemp:studentList) {
	 					String selected = "";
 					if(studentNumber!=null && studentNumber.getUser_name()!=null && studentNumber.getUser_name().equals(studentTemp.getUser_name()))
 						selected = "selected";
	 				%>
 				 <option value="<%=studentTemp.getUser_name() %>" <%=selected %>><%=studentTemp.getStudentName() %></option>
	 				<%
	 				}
	 				%>
 			</select>
            ...
            <div class="form-group">
            	<label for="courseNumber_courseNumber">课程：</label>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="scoreInfo_studentNumber_user_name_edit" class="col-md-3 text-right">学生:</label>
		  	 <div class="col-md-9">
			    <select id="scoreInfo_studentNumber_user_name_edit" name="scoreInfo.studentNumber.user_name" class="form-control">
			    </select>
		  	 </div>
		  </div>
		  <div class="form-group">
		  	 <label for="scoreInfo_courseNumber_courseNumber_edit" class="col-md-3 text-right">课程:</label>
		  	 <div class="col-md-9">
			...
			if (scoreInfo) {
				...
				$.ajax({
					...
					success: function(students,response,status) { 
						$("#scoreInfo_studentNumber_user_name_edit").empty();
						var html="";
		        		$(students).each(function(i,student){
		        			html += "<option value='" + student.user_name + "'>" + student.studentName + "</option>";
		        		});
		        		$("#scoreInfo_studentNumber_user_name_edit").html(html);
		        		$("#scoreInfo_studentNumber_user_name_edit").val(scoreInfo.studentNumberPri);
					}
				});
				$.ajax({
