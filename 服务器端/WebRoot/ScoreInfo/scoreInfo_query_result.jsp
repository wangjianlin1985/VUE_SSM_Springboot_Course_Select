...
<div id="scoreInfo_manage_tool" style="padding:5px;">
	...
	<div style="padding:0 0 0 7px;color:#333;">
		<form id="scoreInfoQueryForm" method="post">
			学生：<input class="textbox" type="text" id="studentNumber_user_name_query" name="studentNumber.user_name" style="width: auto"/>
			课程：<input class="textbox" type="text" id="courseNumber_courseNumber_query" name="courseNumber.courseNumber" style="width: auto"/>
...
<div id="scoreInfoEditDiv">
	<form id="scoreInfoEditForm" enctype="multipart/form-data"  method="post">
		...
		<div>
			...
			<span class="inputControl">
				<input class="textbox"  id="scoreInfo_studentNumber_user_name_edit" name="scoreInfo.studentNumber.user_name" style="width: auto"/>
			</span>
		</div>
		<div>
