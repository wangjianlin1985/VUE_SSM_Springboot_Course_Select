		...
		<div class="row">
			<div class="col-md-10">
				  ...
				  <div class="form-group">
					 <label for="student_user_name" class="col-md-2 text-right">手机号:</label>
					 <div class="col-md-8"> 
					 	<input type="text" id="student_user_name" name="student.user_name" class="form-control" placeholder="请输入手机号">
					 </div>
				  </div> 
				  <div class="form-group">
