...
<%
    ...
    String user_name = (String)request.getAttribute("user_name"); //手机号查询关键字
	...
	<div class="col-md-9 wow fadeInLeft">
		...
		<div class="row">
			...
			<div class="col-md-3 bottom15" <%=clearLeft %>>
			  <a  href="<%=basePath  %>Student/<%=student.getUser_name() %>/frontshow"><img class="img-responsive" src="<%=basePath%><%=student.getStudentPhoto()%>" /></a>
			     <div class="showFields">
			     	<div class="field">
	            		手机号:<%=student.getUser_name() %>
			     	</div>
			     	<div class="field">
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="studentQueryForm" id="studentQueryForm" action="<%=basePath %>Student/frontlist" class="mar_t15" method="post">
			<div class="form-group">
				...
				<input type="text" id="user_name" name="user_name" value="<%=user_name %>" class="form-control" placeholder="请输入手机号">
			</div>
			<div class="form-group">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
			 <label for="student_user_name_edit" class="col-md-3 text-right">手机号:</label>
			 <div class="col-md-9"> 
			 	<input type="text" id="student_user_name_edit" name="student.user_name" class="form-control" placeholder="请输入手机号" readOnly>
			 </div>
		  </div> 
		  <div class="form-group">
		  	 <label for="student_studentNumber_edit" class="col-md-3 text-right">学号:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="student_studentNumber_edit" name="student.studentNumber" class="form-control" placeholder="请输入学号">
			 </div>
		  </div>
		  <div class="form-group">
