...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">vue选课成绩网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>Student/frontlist">学生列表</a></li>
                <li><a href="<%=basePath %>Teacher/frontlist">教师风采</a></li>
                <li><a href="<%=basePath %>CourseInfo/frontlist">课程查询</a></li>
