...
public class ScoreInfoService {
    ...
    public ArrayList<ScoreInfo> queryScoreInfo(Student studentNumber,CourseInfo courseNumber,int currentPage) throws Exception { 
    	...
    	if(null != studentNumber &&  studentNumber.getUser_name() != null  && !studentNumber.getUser_name().equals(""))  where += " and t_scoreInfo.studentNumber='" + studentNumber.getUser_name() + "'";
