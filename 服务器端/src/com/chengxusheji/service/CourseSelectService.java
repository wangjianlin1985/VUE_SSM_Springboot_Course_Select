...
public class CourseSelectService {
    ...
    /*按照查询条件分页查询学生选课记录*/
    public ArrayList<CourseSelect> queryCourseSelect(String selectTime,Student studentNumber,CourseInfo courseNumber,int currentPage) throws Exception { 
     	String where = "where 1=1";
    	if(!selectTime.equals("")) where = where + " and t_courseSelect.selectTime like '%" + selectTime + "%'";
    	if(null != studentNumber &&  studentNumber.getUser_name() != null  && !studentNumber.getUser_name().equals(""))  where += " and t_courseSelect.studentNumber='" + studentNumber.getUser_name() + "'";
    	if(null != courseNumber &&  courseNumber.getCourseNumber() != null  && !courseNumber.getCourseNumber().equals(""))  where += " and t_courseSelect.courseNumber='" + courseNumber.getCourseNumber() + "'";
    	int startIndex = (currentPage-1) * this.rows;
    	return courseSelectMapper.queryCourseSelect(where, startIndex, this.rows);
    }

    /*按照查询条件查询所有记录*/
    public ArrayList<CourseSelect> queryCourseSelect(String selectTime,Student studentNumber,CourseInfo courseNumber) throws Exception  { 
     	String where = "where 1=1";
    	if(!selectTime.equals("")) where = where + " and t_courseSelect.selectTime like '%" + selectTime + "%'";
    	if(null != studentNumber &&  studentNumber.getUser_name() != null && !studentNumber.getUser_name().equals(""))  where += " and t_courseSelect.studentNumber='" + studentNumber.getUser_name() + "'";
    	if(null != courseNumber &&  courseNumber.getCourseNumber() != null && !courseNumber.getCourseNumber().equals(""))  where += " and t_courseSelect.courseNumber='" + courseNumber.getCourseNumber() + "'";
    ...
    /*当前查询条件下计算总的页数和记录数*/
    public void queryTotalPageAndRecordNumber(String selectTime,Student studentNumber,CourseInfo courseNumber) throws Exception {
     	String where = "where 1=1";
    	if(!selectTime.equals("")) where = where + " and t_courseSelect.selectTime like '%" + selectTime + "%'";
    	if(null != studentNumber &&  studentNumber.getUser_name() != null && !studentNumber.getUser_name().equals(""))  where += " and t_courseSelect.studentNumber='" + studentNumber.getUser_name() + "'";
    	if(null != courseNumber &&  courseNumber.getCourseNumber() != null && !courseNumber.getCourseNumber().equals(""))  where += " and t_courseSelect.courseNumber='" + courseNumber.getCourseNumber() + "'";
