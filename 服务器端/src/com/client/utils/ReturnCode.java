...
public enum ReturnCode {
    ...
    CODE_ERROR("90006","验证码不正确"),
    SELECT_COURSE_EXIST("90010","你已经选过此门课程"),
    
    INPUT_PARAM_ERROR("90007","输入参数有错误"),
    PRIMARY_EXIST_ERROR("90008","主键冲突错误"),
	FOREIGN_KEY_CONSTRAINT_ERROR("90009","存在外键约束删除失败");
